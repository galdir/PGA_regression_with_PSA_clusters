...
## 2. Aprimoramento da Clusterização de PSA (Soft Clustering)
...
## 3. Aproveitamento de Features Descartadas
...
## 4. Estratégia de Modelagem e Treinamento
...
## 5. Cuidado com a Remoção de Outliers (Local Outlier Factor)
